...
* <<lib.parseDate,Content timestamps support time>>.
...
** `lib.setDefaultLayout` was removed (default pages values can be set with the `default` argument of <<lib.pagesToList>>).
