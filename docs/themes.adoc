...
A new theme file structure can be created with the styx flake template:
...
Paths or packages from `styxthemes` can be used.

[source, nix]
.Using a local my-theme and the generic-templates theme
----
    themes = [
