  ...
  template =
    ...
    lib.template.normalTemplate (
      ...
      + ''
          ...
          ${templates.bootstrap.alert {
            type = "info";
            content = "<strong>Heads up!</strong> This alert needs your attention, but it's not super important.";
          }}
          ${templates.bootstrap.alert {
            type = "warning";
            content = "<strong>Heads up!</strong> This alert needs your attention, but it's not super important.";
          ...
          ${templates.bootstrap.alert {
            type = "danger";
            content = "<strong>Oh snap!</strong> Change a few things up and try submitting again.";
          }}
          <h4>Code</h4>
          ${templates.tag.codeblock {
            content = lib.template.escapeHTML ''
